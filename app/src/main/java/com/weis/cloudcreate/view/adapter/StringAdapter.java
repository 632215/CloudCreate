...
public class StringAdapter extends RecyclerView.Adapter<StringAdapter.MsgHolder> {
    ...
    public StringAdapter(Context context, List<String> dataList,ItemOnClickListener listener) {
        this.context = context;
        this.dataList = dataList;
    ...
    public MsgHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        MsgHolder holder = new MsgHolder(LayoutInflater.from(context).inflate(R.layout.item_string, parent, false));
        return holder;
    }
    ...
    public class MsgHolder extends RecyclerView.ViewHolder {
        ...
        public MsgHolder(View itemView) {
            super(itemView);
            content = itemView.findViewById(R.id.tx_content);
        }
    }
}
